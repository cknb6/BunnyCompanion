...
- 纯白顶栏 + 在线状态小圆点；消息区柔光渐变底
- 圆角气泡带轻投影；头像描边阴影；图片预览圆角白卡
- 时间戳与系统提示改为居中灰胶囊；快捷指令、附件均为药丸小卡片
- 输入框圆角、聚焦描边；发送按钮悬停 / 按下 / 禁用三态反馈
- 全窗定制细圆角滚动条；拖入文件时显示圆角提示卡片

### 设置窗

- 全控件主题统一：粉色对勾勾选框、圆头滑块、圆角输入框聚焦描边
- 按钮圆角三态（悬停 / 按下 / 禁用）；分区卡片带轻投影
- 同款细圆角滚动条
